...
public class Departamento {
    ...
    public void addFuncionario(Funcionario f){
        funcionarios.add(f); //obj Departamento apontar para um 
                               //obj Horista ou Mensalista ou Comissionado
        f.setDepartamento(this);//obj Horista ou Mensalista ou Comissionado
                                //apontar para um obj Departamento
    }
